...
android {
    namespace = "com.mediaproject.rerollbagadmin"
    compileSdk = AppConfig.compileSdk

    defaultConfig {
        applicationId = "com.mediaproject.rerollbagadmin"
        minSdk = AppConfig.minSdk
        targetSdk = AppConfig.targetSdk
        versionCode = AppConfig.adminVersionCode
        versionName = AppConfig.adminVersionName
        ...
        manifestPlaceholders["ADMIN_GOOGLE_CLIENT_KEY"] = getApiKey("ADMIN_GOOGLE_CLIENT_KEY")
    }
...
dependencies {
    implementation(project(":presentation:admin"))
